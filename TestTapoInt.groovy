...
// ~~~~~ start include (544) davegut.appTpLinkSmart ~~~~~
...
log.trace "getDiscData: $payload" // library marker davegut.appTpLinkSmart, line 139
			...
			String devIp = payload.ip // library marker davegut.appTpLinkSmart, line 143
			String protocol = payload.mgt_encrypt_schm.encrypt_type // library marker davegut.appTpLinkSmart, line 144
			String status = "true" // library marker davegut.appTpLinkSmart, line 145
			if (protocol == "TPAP") {  // library marker davegut.appTpLinkSmart, line 146
				status = "Protocol not supported" // library marker davegut.appTpLinkSmart, line 147
				unsupDev << ["<b>${model}</b>": "Protocol ${protocol} not supported"] // library marker davegut.appTpLinkSmart, line 148
			}	else if (model == "HS200") { // library marker davegut.appTpLinkSmart, line 149
				status = "Device model not supported" // library marker davegut.appTpLinkSmart, line 150
				unsupDev << ["<b>${model}</b>": "Model ${model} not supported"] // library marker davegut.appTpLinkSmart, line 151
			}	else if (!supported.contains(devType)) {  // library marker davegut.appTpLinkSmart, line 152
				status = "Device type not supported"  // library marker davegut.appTpLinkSmart, line 153
				unsupDev << ["<b>${model}</b>": "DevType ${devType} not supported"] // library marker davegut.appTpLinkSmart, line 154
			} // library marker davegut.appTpLinkSmart, line 155
			if (status == "true") { // library marker davegut.appTpLinkSmart, line 156
				String dni = payload.mac.replaceAll("-", "") // library marker davegut.appTpLinkSmart, line 157
				String port = payload.mgt_encrypt_schm.http_port // library marker davegut.appTpLinkSmart, line 158
				String httpStr = "http://" // library marker davegut.appTpLinkSmart, line 159
				String httpPath = "/app" // library marker davegut.appTpLinkSmart, line 160
				if (payload.mgt_encrypt_schm.is_support_https) { // library marker davegut.appTpLinkSmart, line 161
					httpStr = "https://" // library marker davegut.appTpLinkSmart, line 162
				} // library marker davegut.appTpLinkSmart, line 163
				if (devType == "SMART.IPCAMERA" || devType == "SMART.TAPODOORBELL") { // library marker davegut.appTpLinkSmart, line 164
					protocol = "camera" // library marker davegut.appTpLinkSmart, line 165
					port = "443" // library marker davegut.appTpLinkSmart, line 166
				} else if (devType == "SMART.TAPOROBOVAC" && protocol == "AES") { // library marker davegut.appTpLinkSmart, line 167
					protocol = "vacAes" // library marker davegut.appTpLinkSmart, line 168
					httpPath = "" // library marker davegut.appTpLinkSmart, line 169
				} // library marker davegut.appTpLinkSmart, line 170
				String baseUrl = httpStr + devIp + ":" + port + httpPath // library marker davegut.appTpLinkSmart, line 171
				devData << [udpPort: respData.port, type: devType, model: model, baseUrl: baseUrl,  // library marker davegut.appTpLinkSmart, line 172
							dni: dni, ip: devIp, port: port, protocol: protocol, status: "OK"] // library marker davegut.appTpLinkSmart, line 173
				if (payload.power) { devData << [power: payload.power] } // library marker davegut.appTpLinkSmart, line 174
				logDebug(devData) // library marker davegut.appTpLinkSmart, line 175
			} else { // library marker davegut.appTpLinkSmart, line 176
				Map errResp = [method: "getDiscData", payload: payload, status: status] // library marker davegut.appTpLinkSmart, line 177
				logDebug(errResp) // library marker davegut.appTpLinkSmart, line 178
	...
	atomicState.unsupported = unsupDev // library marker davegut.appTpLinkSmart, line 185
	return devData // library marker davegut.appTpLinkSmart, line 186
} // library marker davegut.appTpLinkSmart, line 187

def getAllTpLinkDeviceData(List discData) { // library marker davegut.appTpLinkSmart, line 189
...
def addToDevices(devData, cmdData) { // library marker davegut.appTpLinkSmart, line 219
	...
	atomicState.devices = devicesData // library marker davegut.appTpLinkSmart, line 299
	logData << ["${deviceData.alias}": deviceData, dni: dni] // library marker davegut.appTpLinkSmart, line 300
	Map InfoData = ["${deviceData.alias}": "added to device data"] // library marker davegut.appTpLinkSmart, line 301
	logInfo("${deviceData.alias}: added to device data") // library marker davegut.appTpLinkSmart, line 302
	updateChild(dni, deviceData) // library marker davegut.appTpLinkSmart, line 303
	logDebug(logData) // library marker davegut.appTpLinkSmart, line 304
} // library marker davegut.appTpLinkSmart, line 305

def updateChild(dni, deviceData) { // library marker davegut.appTpLinkSmart, line 307
	def child = getChildDevice(dni) // library marker davegut.appTpLinkSmart, line 308
	if (child) { // library marker davegut.appTpLinkSmart, line 309
		child.updateChild(deviceData) // library marker davegut.appTpLinkSmart, line 310
	} // library marker davegut.appTpLinkSmart, line 311
} // library marker davegut.appTpLinkSmart, line 312

//	===== get Smart KLAP Protocol Data ===== // library marker davegut.appTpLinkSmart, line 314
def sendKlapDataCmd(handshakeData, data) { // library marker davegut.appTpLinkSmart, line 315
	if (handshakeData.respStatus != "Login OK") { // library marker davegut.appTpLinkSmart, line 316
		Map logData = [method: "sendKlapDataCmd", handshake: handshakeData, data: data] // library marker davegut.appTpLinkSmart, line 317
		logWarn(logData) // library marker davegut.appTpLinkSmart, line 318
	} else { // library marker davegut.appTpLinkSmart, line 319
		Map reqParams = [timeout: 10, headers: ["Cookie": data.data.cookie]] // library marker davegut.appTpLinkSmart, line 320
		def seqNo = data.data.seqNo + 1 // library marker davegut.appTpLinkSmart, line 321
		String cmdBodyJson = new groovy.json.JsonBuilder(getDataCmd()).toString() // library marker davegut.appTpLinkSmart, line 322
		Map encryptedData = klapEncrypt(cmdBodyJson.getBytes(), data.data.encKey,  // library marker davegut.appTpLinkSmart, line 323
										data.data.encIv, data.data.encSig, seqNo) // library marker davegut.appTpLinkSmart, line 324
		reqParams << [ // library marker davegut.appTpLinkSmart, line 325
			uri: "${data.data.devData.baseUrl}/request?seq=${encryptedData.seqNumber}", // library marker davegut.appTpLinkSmart, line 326
			body: encryptedData.cipherData, // library marker davegut.appTpLinkSmart, line 327
			ignoreSSLIssues: true, // library marker davegut.appTpLinkSmart, line 328
			timeout:10, // library marker davegut.appTpLinkSmart, line 329
			contentType: "application/octet-stream", // library marker davegut.appTpLinkSmart, line 330
			requestContentType: "application/octet-stream"] // library marker davegut.appTpLinkSmart, line 331
		asynchttpPost("parseKlapResp", reqParams, [data: data]) // library marker davegut.appTpLinkSmart, line 332
	} // library marker davegut.appTpLinkSmart, line 333
} // library marker davegut.appTpLinkSmart, line 334

def parseKlapResp(resp, respData) { // library marker davegut.appTpLinkSmart, line 336
	Map data = respData.data // library marker davegut.appTpLinkSmart, line 337
	Map logData = [method: "parseKlapResp", ip: data.data.devData.ip, model: data.data.devData.model] // library marker davegut.appTpLinkSmart, line 338
	if (resp.status == 200) { // library marker davegut.appTpLinkSmart, line 339
		try { // library marker davegut.appTpLinkSmart, line 340
			byte[] cipherResponse = resp.data.decodeBase64()[32..-1] // library marker davegut.appTpLinkSmart, line 341
			def clearResp = klapDecrypt(cipherResponse, data.data.encKey, // library marker davegut.appTpLinkSmart, line 342
										data.data.encIv, data.data.seqNo + 1) // library marker davegut.appTpLinkSmart, line 343
			Map cmdResp =  new JsonSlurper().parseText(clearResp) // library marker davegut.appTpLinkSmart, line 344
			logData << [status: "OK"] // library marker davegut.appTpLinkSmart, line 345
			if (cmdResp.error_code == 0) { // library marker davegut.appTpLinkSmart, line 346
				addToDevices(data.data.devData, cmdResp.result.responses) // library marker davegut.appTpLinkSmart, line 347
				logDebug(logData) // library marker davegut.appTpLinkSmart, line 348
			} else { // library marker davegut.appTpLinkSmart, line 349
				logData << [status: "errorInCmdResp", cmdResp: cmdResp] // library marker davegut.appTpLinkSmart, line 350
				logWarn(logData) // library marker davegut.appTpLinkSmart, line 351
			} // library marker davegut.appTpLinkSmart, line 352
		} catch (err) { // library marker davegut.appTpLinkSmart, line 353
			logData << [status: "deviceDataParseError", error: err, dataLength: resp.data.length()] // library marker davegut.appTpLinkSmart, line 354
			logWarn(logData) // library marker davegut.appTpLinkSmart, line 355
		} // library marker davegut.appTpLinkSmart, line 356
	} else { // library marker davegut.appTpLinkSmart, line 357
		logData << [status: "httpFailure", data: resp.properties] // library marker davegut.appTpLinkSmart, line 358
		logWarn(logData) // library marker davegut.appTpLinkSmart, line 359
	} // library marker davegut.appTpLinkSmart, line 360
} // library marker davegut.appTpLinkSmart, line 361

//	===== get Smart Camera Protocol Data ===== // library marker davegut.appTpLinkSmart, line 363
def sendCameraDataCmd(devData, camCmdIn) { // library marker davegut.appTpLinkSmart, line 364
	List requests = [[method:"getDeviceInfo", params:[device_info:[name:["basic_info"]]]], // library marker davegut.appTpLinkSmart, line 365
					 [method:"getAppComponentList", params:[app_component:[name:"app_component_list"]]]] // library marker davegut.appTpLinkSmart, line 366
	Map cmdBody = [method: "multipleRequest", params: [requests: requests]] // library marker davegut.appTpLinkSmart, line 367
	def cmdStr = JsonOutput.toJson(cmdBody) // library marker davegut.appTpLinkSmart, line 368
	Map reqBody = [method: "securePassthrough", // library marker davegut.appTpLinkSmart, line 369
				   params: [request: aesEncrypt(cmdStr, camCmdIn.lsk, camCmdIn.ivb)]] // library marker davegut.appTpLinkSmart, line 370
	String cmdData = new groovy.json.JsonBuilder(reqBody).toString() // library marker davegut.appTpLinkSmart, line 371
	String initTagHex = camCmdIn.encPwd + camCmdIn.cnonce // library marker davegut.appTpLinkSmart, line 372
	String initTag = mdEncode("SHA-256", initTagHex.getBytes()).encodeHex().toString().toUpperCase() // library marker davegut.appTpLinkSmart, line 373
	String tagString = initTag + cmdData + camCmdIn.seqNo // library marker davegut.appTpLinkSmart, line 374
	String tag =  mdEncode("SHA-256", tagString.getBytes()).encodeHex().toString().toUpperCase() // library marker davegut.appTpLinkSmart, line 375
	Map heads = getCamHeaders() // library marker davegut.appTpLinkSmart, line 376
	heads << ["Tapo_tag": tag, Seq: camCmdIn.seqNo] // library marker davegut.appTpLinkSmart, line 377
	Map reqParams = [uri: camCmdIn.apiUrl, // library marker davegut.appTpLinkSmart, line 378
					 body: cmdData, // library marker davegut.appTpLinkSmart, line 379
					 ...
					 ignoreSSLIssues: true, // library marker davegut.appTpLinkSmart, line 383
					 headers: heads // library marker davegut.appTpLinkSmart, line 384
					] // library marker davegut.appTpLinkSmart, line 385
	asynchttpPost("parseCameraResp", reqParams, [data: [devData: devData, camCmdIn: camCmdIn]]) // library marker davegut.appTpLinkSmart, line 386
} // library marker davegut.appTpLinkSmart, line 387

def parseCameraResp(resp, data) { // library marker davegut.appTpLinkSmart, line 389
	Map logData = [method: "parseCameraResp", ip: data.data.devData.ip] // library marker davegut.appTpLinkSmart, line 390
	if (resp.json.error_code == 0) { // library marker davegut.appTpLinkSmart, line 391
		resp = resp.json // library marker davegut.appTpLinkSmart, line 392
		try { // library marker davegut.appTpLinkSmart, line 393
			def clearResp = aesDecrypt(resp.result.response, data.data.camCmdIn.lsk,  // library marker davegut.appTpLinkSmart, line 394
									   data.data.camCmdIn.ivb) // library marker davegut.appTpLinkSmart, line 395
			Map cmdResp =  new JsonSlurper().parseText(clearResp) // library marker davegut.appTpLinkSmart, line 396
			logData << [status: "OK"] // library marker davegut.appTpLinkSmart, line 397
			if (cmdResp.error_code == 0) { // library marker davegut.appTpLinkSmart, line 398
				addToDevices(data.data.devData, cmdResp.result.responses) // library marker davegut.appTpLinkSmart, line 399
                logDebug(logData) // library marker davegut.appTpLinkSmart, line 400
			} else { // library marker davegut.appTpLinkSmart, line 401
				logData << [status: "errorInCmdResp", cmdResp: cmdResp] // library marker davegut.appTpLinkSmart, line 402
				logWarn(logData) // library marker davegut.appTpLinkSmart, line 403
			} // library marker davegut.appTpLinkSmart, line 404
		} catch (err) { // library marker davegut.appTpLinkSmart, line 405
			logData << [status: "decryptDataError", error: err] // library marker davegut.appTpLinkSmart, line 406
		...
		logData << [status: "rerurnDataErrorCode", resp: resp] // library marker davegut.appTpLinkSmart, line 410
...
//	===== get Smart AES Protocol Data ===== // library marker davegut.appTpLinkSmart, line 415
def getAesToken(resp, data) { // library marker davegut.appTpLinkSmart, line 416
	Map logData = [method: "getAesToken"] // library marker davegut.appTpLinkSmart, line 417
	if (resp.status == 200) { // library marker davegut.appTpLinkSmart, line 418
		if (resp.json.error_code == 0) { // library marker davegut.appTpLinkSmart, line 419
			try { // library marker davegut.appTpLinkSmart, line 420
				def clearResp = aesDecrypt(resp.json.result.response, data.encKey, data.encIv) // library marker davegut.appTpLinkSmart, line 421
				Map cmdResp = new JsonSlurper().parseText(clearResp) // library marker davegut.appTpLinkSmart, line 422
				if (cmdResp.error_code == 0) { // library marker davegut.appTpLinkSmart, line 423
					def token = cmdResp.result.token // library marker davegut.appTpLinkSmart, line 424
					logData << [respStatus: "OK", token: token] // library marker davegut.appTpLinkSmart, line 425
					logDebug(logData) // library marker davegut.appTpLinkSmart, line 426
					sendAesDataCmd(token, data) // library marker davegut.appTpLinkSmart, line 427
				} else { // library marker davegut.appTpLinkSmart, line 428
					logData << [respStatus: "ERROR code in cmdResp",  // library marker davegut.appTpLinkSmart, line 429
								error_code: cmdResp.error_code, // library marker davegut.appTpLinkSmart, line 430
								check: "cryptoArray, credentials", data: cmdResp] // library marker davegut.appTpLinkSmart, line 431
					logWarn(logData) // library marker davegut.appTpLinkSmart, line 432
				} // library marker davegut.appTpLinkSmart, line 433
			} catch (err) { // library marker davegut.appTpLinkSmart, line 434
				logData << [respStatus: "ERROR parsing respJson", respJson: resp.json, // library marker davegut.appTpLinkSmart, line 435
							error: err] // library marker davegut.appTpLinkSmart, line 436
			...
			logData << [respStatus: "ERROR code in resp.json", errorCode: resp.json.error_code, // library marker davegut.appTpLinkSmart, line 440
						respJson: resp.json] // library marker davegut.appTpLinkSmart, line 441
		...
		logData << [respStatus: "ERROR in HTTP response", respStatus: resp.status, data: resp.properties] // library marker davegut.appTpLinkSmart, line 445
...
def sendAesDataCmd(token, data) { // library marker davegut.appTpLinkSmart, line 450
	def cmdStr = JsonOutput.toJson(getDataCmd()).toString() // library marker davegut.appTpLinkSmart, line 451
	Map reqBody = [method: "securePassthrough", // library marker davegut.appTpLinkSmart, line 452
				   params: [request: aesEncrypt(cmdStr, data.encKey, data.encIv)]] // library marker davegut.appTpLinkSmart, line 453
	Map reqParams = [uri: "${data.baseUrl}?token=${token}", // library marker davegut.appTpLinkSmart, line 454
					 body: new groovy.json.JsonBuilder(reqBody).toString(), // library marker davegut.appTpLinkSmart, line 455
					 contentType: "application/json", // library marker davegut.appTpLinkSmart, line 456
					 requestContentType: "application/json", // library marker davegut.appTpLinkSmart, line 457
					 timeout: 10, // library marker davegut.appTpLinkSmart, line 458
					 headers: ["Cookie": data.cookie]] // library marker davegut.appTpLinkSmart, line 459
	asynchttpPost("parseAesResp", reqParams, [data: data]) // library marker davegut.appTpLinkSmart, line 460
} // library marker davegut.appTpLinkSmart, line 461

def parseAesResp(resp, data) { // library marker davegut.appTpLinkSmart, line 463
	Map logData = [method: "parseAesResp"] // library marker davegut.appTpLinkSmart, line 464
	if (resp.status == 200) { // library marker davegut.appTpLinkSmart, line 465
		try { // library marker davegut.appTpLinkSmart, line 466
			Map cmdResp = new JsonSlurper().parseText(aesDecrypt(resp.json.result.response, // library marker davegut.appTpLinkSmart, line 467
																 data.data.encKey, data.data.encIv)) // library marker davegut.appTpLinkSmart, line 468
			logData << [status: "OK", cmdResp: cmdResp] // library marker davegut.appTpLinkSmart, line 469
			if (cmdResp.error_code == 0) { // library marker davegut.appTpLinkSmart, line 470
				addToDevices(data.data.devData, cmdResp.result.responses) // library marker davegut.appTpLinkSmart, line 471
				logDebug(logData) // library marker davegut.appTpLinkSmart, line 472
			} else { // library marker davegut.appTpLinkSmart, line 473
				logData << [status: "errorInCmdResp"] // library marker davegut.appTpLinkSmart, line 474
				logWarn(logData) // library marker davegut.appTpLinkSmart, line 475
			} // library marker davegut.appTpLinkSmart, line 476
		} catch (err) { // library marker davegut.appTpLinkSmart, line 477
			logData << [status: "deviceDataParseError", error: err, dataLength: resp.data.length()] // library marker davegut.appTpLinkSmart, line 478
			logWarn(logData) // library marker davegut.appTpLinkSmart, line 479
		} // library marker davegut.appTpLinkSmart, line 480
	} else { // library marker davegut.appTpLinkSmart, line 481
		logData << [status: "httpFailure", data: resp.properties] // library marker davegut.appTpLinkSmart, line 482
...
//	===== get Smart vacAes Protocol Data ===== // library marker davegut.appTpLinkSmart, line 487
def sendVacAesDataCmd(token, data) { // library marker davegut.appTpLinkSmart, line 488
	Map devData = data.data.devData // library marker davegut.appTpLinkSmart, line 489
	Map reqParams = getVacAesParams(getDataCmd(), "${data.data.baseUrl}/?token=${token}") // library marker davegut.appTpLinkSmart, line 490
	asynchttpPost("parseVacAesResp", reqParams, [data: devData]) // library marker davegut.appTpLinkSmart, line 491
} // library marker davegut.appTpLinkSmart, line 492

def parseVacAesResp(resp, devData) { // library marker davegut.appTpLinkSmart, line 494
	Map logData = [parseMethod: "parseVacAesResp"] // library marker davegut.appTpLinkSmart, line 495
	try { // library marker davegut.appTpLinkSmart, line 496
		Map cmdResp = resp.json // library marker davegut.appTpLinkSmart, line 497
		logData << [status: "OK", cmdResp: cmdResp] // library marker davegut.appTpLinkSmart, line 498
			if (cmdResp.error_code == 0) { // library marker davegut.appTpLinkSmart, line 499
				addToDevices(devData.data, cmdResp.result.responses) // library marker davegut.appTpLinkSmart, line 500
				logDebug(logData) // library marker davegut.appTpLinkSmart, line 501
			} else { // library marker davegut.appTpLinkSmart, line 502
				logData << [status: "errorInCmdResp"] // library marker davegut.appTpLinkSmart, line 503
				logWarn(logData) // library marker davegut.appTpLinkSmart, line 504
			} // library marker davegut.appTpLinkSmart, line 505
	} catch (err) { // library marker davegut.appTpLinkSmart, line 506
		logData << [status: "deviceDataParseError", error: err, dataLength: resp.data.length()] // library marker davegut.appTpLinkSmart, line 507
		logWarn(logData) // library marker davegut.appTpLinkSmart, line 508
	} // library marker davegut.appTpLinkSmart, line 509
	return parseData // library marker davegut.appTpLinkSmart, line 510
} // library marker davegut.appTpLinkSmart, line 511

//	===== Support device data update request ===== // library marker davegut.appTpLinkSmart, line 513
def tpLinkCheckForDevices(timeout = 5) { // library marker davegut.appTpLinkSmart, line 514
	Map logData = [method: "tpLinkCheckForDevices"] // library marker davegut.appTpLinkSmart, line 515
	def checked = true // library marker davegut.appTpLinkSmart, line 516
	if (state.tpLinkChecked == true) { // library marker davegut.appTpLinkSmart, line 517
		checked = false // library marker davegut.appTpLinkSmart, line 518
		logData << [status: "noCheck", reason: "Completed within last 10 minutes"] // library marker davegut.appTpLinkSmart, line 519
	} else { // library marker davegut.appTpLinkSmart, line 520
		def findData = findTpLinkDevices("parseTpLinkCheck", timeout) // library marker davegut.appTpLinkSmart, line 521
		logData << [status: "checking"] // library marker davegut.appTpLinkSmart, line 522
		pauseExecution((timeout+2)*1000) // library marker davegut.appTpLinkSmart, line 523
	} // library marker davegut.appTpLinkSmart, line 524
	logDebug(logData) // library marker davegut.appTpLinkSmart, line 525
	return checked // library marker davegut.appTpLinkSmart, line 526
} // library marker davegut.appTpLinkSmart, line 527

def resetTpLinkChecked() { state.tpLinkChecked = false } // library marker davegut.appTpLinkSmart, line 529

def parseTpLinkCheck(response) { // library marker davegut.appTpLinkSmart, line 531
	List discData = [] // library marker davegut.appTpLinkSmart, line 532
	if (response instanceof Map) { // library marker davegut.appTpLinkSmart, line 533
		Map devdata = getDiscData(response) // library marker davegut.appTpLinkSmart, line 534
		if (devData.status != "INVALID") { // library marker davegut.appTpLinkSmart, line 535
			discData << devData // library marker davegut.appTpLinkSmart, line 536
		} // library marker davegut.appTpLinkSmart, line 537
	} else { // library marker davegut.appTpLinkSmart, line 538
		response.each { // library marker davegut.appTpLinkSmart, line 539
			Map devData = getDiscData(it) // library marker davegut.appTpLinkSmart, line 540
			if (devData.status == "OK") { // library marker davegut.appTpLinkSmart, line 541
				discData << devData // library marker davegut.appTpLinkSmart, line 542
	...
	updateTpLinkDevices(discData) // library marker davegut.appTpLinkSmart, line 546
} // library marker davegut.appTpLinkSmart, line 547

def updateTpLinkDevices(discData) { // library marker davegut.appTpLinkSmart, line 549
	Map logData = [method: "updateTpLinkDevices"] // library marker davegut.appTpLinkSmart, line 550
	state.tpLinkChecked = true // library marker davegut.appTpLinkSmart, line 551
	runIn(570, resetTpLinkChecked) // library marker davegut.appTpLinkSmart, line 552
	List children = getChildDevices() // library marker davegut.appTpLinkSmart, line 553
	children.each { childDev -> // library marker davegut.appTpLinkSmart, line 554
		Map childData = [:] // library marker davegut.appTpLinkSmart, line 555
		def dni = childDev.deviceNetworkId // library marker davegut.appTpLinkSmart, line 556
		def connected = "false" // library marker davegut.appTpLinkSmart, line 557
		Map devData = discData.find{ it.dni == dni } // library marker davegut.appTpLinkSmart, line 558
		if (childDev.getDataValue("baseUrl")) { // library marker davegut.appTpLinkSmart, line 559
			if (devData != null) { // library marker davegut.appTpLinkSmart, line 560
				if (childDev.getDataValue("baseUrl") == devData.baseUrl && // library marker davegut.appTpLinkSmart, line 561
				    childDev.getDataValue("protocol") == devData.protocol) { // library marker davegut.appTpLinkSmart, line 562
					childData << [status: "noChanges"] // library marker davegut.appTpLinkSmart, line 563
				} else { // library marker davegut.appTpLinkSmart, line 564
					childDev.updateDataValue("baseUrl", devData.baseUrl) // library marker davegut.appTpLinkSmart, line 565
					childDev.updateDataValue("protocol", devData.protocol) // library marker davegut.appTpLinkSmart, line 566
					childData << ["baseUrl": devData.baseUrl, // library marker davegut.appTpLinkSmart, line 567
								  "protocol": devData.protocol, // library marker davegut.appTpLinkSmart, line 568
								  "connected": "true"] // library marker davegut.appTpLinkSmart, line 569
				} // library marker davegut.appTpLinkSmart, line 570
			} // library marker davegut.appTpLinkSmart, line 571
			pauseExecution(500) // library marker davegut.appTpLinkSmart, line 572
		} // library marker davegut.appTpLinkSmart, line 573
		logData << ["${childDev}": childData] // library marker davegut.appTpLinkSmart, line 574
	} // library marker davegut.appTpLinkSmart, line 575
	logDebug(logData) // library marker davegut.appTpLinkSmart, line 576
} // library marker davegut.appTpLinkSmart, line 577

// ~~~~~ end include (544) davegut.appTpLinkSmart ~~~~~

// ~~~~~ start include (555) davegut.tpLinkComms ~~~~~
...
// ~~~~~ end include (555) davegut.tpLinkComms ~~~~~

// ~~~~~ start include (556) davegut.tpLinkCrypto ~~~~~
...
// ~~~~~ end include (556) davegut.tpLinkCrypto ~~~~~

// ~~~~~ start include (558) davegut.tpLinkTransAes ~~~~~
...
// ~~~~~ end include (558) davegut.tpLinkTransAes ~~~~~

// ~~~~~ start include (547) davegut.tpLinkCamTransport ~~~~~
...
// ~~~~~ end include (547) davegut.tpLinkCamTransport ~~~~~

// ~~~~~ start include (559) davegut.tpLinkTransKlap ~~~~~
...
def klapHandshake(baseUrl, localHash, devData = null) { // library marker davegut.tpLinkTransKlap, line 10
	...
	Map reqParams = [uri: "${baseUrl}/handshake1", // library marker davegut.tpLinkTransKlap, line 13
					 ...
					 timeout:30, // library marker davegut.tpLinkTransKlap, line 17
					 ignoreSSLIssues: true] // library marker davegut.tpLinkTransKlap, line 18
log.trace "klapHandshake: $reqParams" // library marker davegut.tpLinkTransKlap, line 19
	asynchttpPost("parseKlapHandshake", reqParams, [data: reqData]) // library marker davegut.tpLinkTransKlap, line 20
} // library marker davegut.tpLinkTransKlap, line 21

def parseKlapHandshake(resp, data) { // library marker davegut.tpLinkTransKlap, line 23
log.trace "parseKlapHandshake: ${resp.properties}" // library marker davegut.tpLinkTransKlap, line 24
	Map reqData = [devData: data.data.devData] // library marker davegut.tpLinkTransKlap, line 25
	hs1Success = false // library marker davegut.tpLinkTransKlap, line 26
	if (resp.status == 200 && resp.data != null) { // library marker davegut.tpLinkTransKlap, line 27
		try { // library marker davegut.tpLinkTransKlap, line 28
			byte[] localSeed = data.data.localSeed // library marker davegut.tpLinkTransKlap, line 29
			byte[] seedData = resp.data.decodeBase64() // library marker davegut.tpLinkTransKlap, line 30
			byte[] remoteSeed = seedData[0 .. 15] // library marker davegut.tpLinkTransKlap, line 31
			byte[] serverHash = seedData[16 .. 47] // library marker davegut.tpLinkTransKlap, line 32
			byte[] localHash = data.data.localHash.decodeBase64() // library marker davegut.tpLinkTransKlap, line 33
			byte[] authHash = [localSeed, remoteSeed, localHash].flatten() // library marker davegut.tpLinkTransKlap, line 34
			byte[] localAuthHash = mdEncode("SHA-256", authHash) // library marker davegut.tpLinkTransKlap, line 35
			if (localAuthHash == serverHash) { // library marker davegut.tpLinkTransKlap, line 36
				//	cookie // library marker davegut.tpLinkTransKlap, line 37
				def cookieHeader = resp.headers["Set-Cookie"].toString() // library marker davegut.tpLinkTransKlap, line 38
				def cookie = cookieHeader.substring(cookieHeader.indexOf(":") +1, cookieHeader.indexOf(";")) // library marker davegut.tpLinkTransKlap, line 39
				//	seqNo and encIv // library marker davegut.tpLinkTransKlap, line 40
				byte[] payload = ["iv".getBytes(), localSeed, remoteSeed, localHash].flatten() // library marker davegut.tpLinkTransKlap, line 41
				byte[] fullIv = mdEncode("SHA-256", payload) // library marker davegut.tpLinkTransKlap, line 42
				byte[] byteSeqNo = fullIv[-4..-1] // library marker davegut.tpLinkTransKlap, line 43
				int seqNo = byteArrayToInteger(byteSeqNo) // library marker davegut.tpLinkTransKlap, line 44
				if (device) { // library marker davegut.tpLinkTransKlap, line 45
					state.seqNo = seqNo // library marker davegut.tpLinkTransKlap, line 46
				} else { // library marker davegut.tpLinkTransKlap, line 47
					atomicState.seqNo = seqNo // library marker davegut.tpLinkTransKlap, line 48
				} // library marker davegut.tpLinkTransKlap, line 49
				...
				hs1Success = true // library marker davegut.tpLinkTransKlap, line 56
				logDebug([parseKlapHandshake: reqData]) // library marker davegut.tpLinkTransKlap, line 57
				if (device) { // library marker davegut.tpLinkTransKlap, line 58
					device.updateSetting("cookie",[type:"password", value: cookie])  // library marker davegut.tpLinkTransKlap, line 59
					device.updateSetting("encKey",[type:"password", value: encKey])  // library marker davegut.tpLinkTransKlap, line 60
					device.updateSetting("encIv",[type:"password", value: fullIv[0..11]])  // library marker davegut.tpLinkTransKlap, line 61
					device.updateSetting("encSig",[type:"password", value: encSig])  // library marker davegut.tpLinkTransKlap, line 62
				} else { // library marker davegut.tpLinkTransKlap, line 63
					reqData << [cookie: cookie, seqNo: seqNo, encIv: fullIv[0..11],  // library marker davegut.tpLinkTransKlap, line 64
								encSig: encSig, encKey: encKey] // library marker davegut.tpLinkTransKlap, line 65
				} // library marker davegut.tpLinkTransKlap, line 66
				byte[] loginHash = [remoteSeed, localSeed, localHash].flatten() // library marker davegut.tpLinkTransKlap, line 67
				byte[] body = mdEncode("SHA-256", loginHash) // library marker davegut.tpLinkTransKlap, line 68
				Map reqParams = [uri: "${data.data.baseUrl}/handshake2", // library marker davegut.tpLinkTransKlap, line 69
								 body: body, // library marker davegut.tpLinkTransKlap, line 70
								 timeout:10, // library marker davegut.tpLinkTransKlap, line 71
								 ignoreSSLIssues: true, // library marker davegut.tpLinkTransKlap, line 72
								 headers: ["Cookie": cookie], // library marker davegut.tpLinkTransKlap, line 73
								 contentType: "application/octet-stream", // library marker davegut.tpLinkTransKlap, line 74
								 requestContentType: "application/octet-stream"] // library marker davegut.tpLinkTransKlap, line 75
				asynchttpPost("parseKlapHandshake2", reqParams, [data: reqData]) // library marker davegut.tpLinkTransKlap, line 76
			} else { // library marker davegut.tpLinkTransKlap, line 77
				reqData << [respStatus: "ERROR: localAuthHash != serverHash", // library marker davegut.tpLinkTransKlap, line 78
							action: "<b>Check credentials and try again</b>"] // library marker davegut.tpLinkTransKlap, line 79
			} // library marker davegut.tpLinkTransKlap, line 80
		} catch (err) { // library marker davegut.tpLinkTransKlap, line 81
			reqData << [respStatus: "ERROR parsing 200 response", resp: resp.properties, error: err, // library marker davegut.tpLinkTransKlap, line 82
						action: "<b>Try Configure command</b>"] // library marker davegut.tpLinkTransKlap, line 83
		} // library marker davegut.tpLinkTransKlap, line 84
	} else { // library marker davegut.tpLinkTransKlap, line 85
		reqData << [respStatus: resp.status, message: resp.errorMessage, // library marker davegut.tpLinkTransKlap, line 86
					action: "<b>Try Configure command</b>"] // library marker davegut.tpLinkTransKlap, line 87
	} // library marker davegut.tpLinkTransKlap, line 88
	reqData << [hs1Success: hs1Success] // library marker davegut.tpLinkTransKlap, line 89
	if (hs1Success == false) {  // library marker davegut.tpLinkTransKlap, line 90
		logWarn([parseKlapHandshake: reqData]) // library marker davegut.tpLinkTransKlap, line 91
	} // library marker davegut.tpLinkTransKlap, line 92
} // library marker davegut.tpLinkTransKlap, line 93

def parseKlapHandshake2(resp, data) { // library marker davegut.tpLinkTransKlap, line 95
	Map logData = [method: "parseKlapHandshake2"] // library marker davegut.tpLinkTransKlap, line 96
	if (resp.status == 200 && resp.data == null) { // library marker davegut.tpLinkTransKlap, line 97
		logData << [respStatus: "Login OK"] // library marker davegut.tpLinkTransKlap, line 98
		setCommsError(200) // library marker davegut.tpLinkTransKlap, line 99
		logDebug(logData) // library marker davegut.tpLinkTransKlap, line 100
	} else { // library marker davegut.tpLinkTransKlap, line 101
		logData << [respStatus: "LOGIN FAILED", reason: "ERROR in HTTP response", // library marker davegut.tpLinkTransKlap, line 102
					resp: resp.properties] // library marker davegut.tpLinkTransKlap, line 103
		logWarn(logData) // library marker davegut.tpLinkTransKlap, line 104
	} // library marker davegut.tpLinkTransKlap, line 105
	if (!device) { sendKlapDataCmd(logData, data) } // library marker davegut.tpLinkTransKlap, line 106
} // library marker davegut.tpLinkTransKlap, line 107

def getKlapParams(cmdBody) { // library marker davegut.tpLinkTransKlap, line 109
	int seqNo = state.seqNo + 1 // library marker davegut.tpLinkTransKlap, line 110
	state.seqNo = seqNo // library marker davegut.tpLinkTransKlap, line 111
	byte[] encKey = new JsonSlurper().parseText(encKey) // library marker davegut.tpLinkTransKlap, line 112
	byte[] encIv = new JsonSlurper().parseText(encIv) // library marker davegut.tpLinkTransKlap, line 113
	byte[] encSig = new JsonSlurper().parseText(encSig) // library marker davegut.tpLinkTransKlap, line 114
	String cmdBodyJson = new groovy.json.JsonBuilder(cmdBody).toString() // library marker davegut.tpLinkTransKlap, line 115

	Map encryptedData = klapEncrypt(cmdBodyJson.getBytes(), encKey, encIv, // library marker davegut.tpLinkTransKlap, line 117
									encSig, seqNo) // library marker davegut.tpLinkTransKlap, line 118
	Map reqParams = [ // library marker davegut.tpLinkTransKlap, line 119
		uri: "${getDataValue("baseUrl")}/request?seq=${seqNo}", // library marker davegut.tpLinkTransKlap, line 120
		body: encryptedData.cipherData, // library marker davegut.tpLinkTransKlap, line 121
		headers: ["Cookie": cookie], // library marker davegut.tpLinkTransKlap, line 122
		contentType: "application/octet-stream", // library marker davegut.tpLinkTransKlap, line 123
		requestContentType: "application/octet-stream", // library marker davegut.tpLinkTransKlap, line 124
		timeout: 10, // library marker davegut.tpLinkTransKlap, line 125
		ignoreSSLIssues: true] // library marker davegut.tpLinkTransKlap, line 126
	return reqParams // library marker davegut.tpLinkTransKlap, line 127
} // library marker davegut.tpLinkTransKlap, line 128

def parseKlapData(resp, data) { // library marker davegut.tpLinkTransKlap, line 130
	Map parseData = [Method: "parseKlapData", sourceMethod: data.data] // library marker davegut.tpLinkTransKlap, line 131
	try { // library marker davegut.tpLinkTransKlap, line 132
		byte[] encKey = new JsonSlurper().parseText(encKey) // library marker davegut.tpLinkTransKlap, line 133
		byte[] encIv = new JsonSlurper().parseText(encIv) // library marker davegut.tpLinkTransKlap, line 134
		int seqNo = state.seqNo // library marker davegut.tpLinkTransKlap, line 135
		byte[] cipherResponse = resp.data.decodeBase64()[32..-1] // library marker davegut.tpLinkTransKlap, line 136
		Map cmdResp =  new JsonSlurper().parseText(klapDecrypt(cipherResponse, encKey, // library marker davegut.tpLinkTransKlap, line 137
														   encIv, seqNo)) // library marker davegut.tpLinkTransKlap, line 138
		parseData << [cryptoStatus: "OK", cmdResp: cmdResp] // library marker davegut.tpLinkTransKlap, line 139
	} catch (err) { // library marker davegut.tpLinkTransKlap, line 140
		parseData << [cryptoStatus: "decryptDataError", error: err] // library marker davegut.tpLinkTransKlap, line 141
	} // library marker davegut.tpLinkTransKlap, line 142
	return parseData // library marker davegut.tpLinkTransKlap, line 143
} // library marker davegut.tpLinkTransKlap, line 144

// ~~~~~ end include (559) davegut.tpLinkTransKlap ~~~~~

// ~~~~~ start include (560) davegut.tpLinkTransVacAes ~~~~~
...
// ~~~~~ end include (560) davegut.tpLinkTransVacAes ~~~~~

// ~~~~~ start include (545) davegut.Logging ~~~~~
...
def version() { return "TEST:   " } // library marker davegut.Logging, line 12
...
// ~~~~~ end include (545) davegut.Logging ~~~~~
